...
public class Contact implements Serializable {
    ...
    public static Contact fromString(String JSONContact) {
    ...
    public static Contact getContactByPersonId(String personId) 
        throws SQLException {
        ...
        try {
            ...
            String sql = "SELECT * FROM contact WHERE person_id = '" + personId + "'";
            Statement st = dbConn.createStatement();
            ResultSet rs = st.executeQuery(sql);
            
            while(rs.next()) {
                contact.setContactId(rs.getInt("contact_id"));
                contact.setCell1(rs.getString("cell1"));
                contact.setTel1(rs.getString("tel1"));
                contact.setEmail(rs.getString("email"));
                contact.setFax(rs.getString("fax"));
                contact.setPersonId(rs.getString("person_id"));
            }
